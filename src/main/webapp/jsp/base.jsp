...
<head>
    <meta charset="UTF-8">
    <title><c:out value="${pageTitle != null ? pageTitle : '勤怠管理システム'}"/></title>
    ...
    <ul class="nav__list">
      <c:choose>
        <c:when test="${user.role == 'admin'}">
          ...
          <li class="nav__item"><a href="${pageContext.request.contextPath}/employee_request_admin" class="nav__link">残業&有給管理</a></li>
          <li class="nav__item"><a href="${pageContext.request.contextPath}/logout" class="nav__link">ログアウト</a></li>
        </c:when>
        <c:otherwise>
